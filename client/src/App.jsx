    ...
    if (this.state.error) {
      return (
        <div className="flex min-h-screen items-center justify-center bg-slate-950 p-6 text-white">
          <div className="max-w-lg rounded-3xl border border-white/10 bg-white/10 p-8 shadow-2xl">
            <h1 className="text-2xl font-black">Ứng dụng gặp lỗi</h1>
            <p className="mt-3 text-sm text-slate-200">
              Vui lòng tải lại trang. Nếu lỗi còn tiếp diễn, hãy đăng xuất rồi đăng nhập lại.
            </p>
            ...
            <button
              ...
              className="mt-5 rounded-2xl bg-sky-600 px-5 py-3 text-sm font-bold text-white"
            >
              Tải lại
            </button>
          </div>
